"""
Django settings for collegefeedback project.
...
SECRET_KEY = 'django-insecure-3o!swrji2v=*f^!nn&ys0q#00jl$-zry#b_pr9wpci7=-@qzyq'
...
ROOT_URLCONF = 'collegefeedback.urls'
...
WSGI_APPLICATION = 'collegefeedback.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'static/admin/images')
